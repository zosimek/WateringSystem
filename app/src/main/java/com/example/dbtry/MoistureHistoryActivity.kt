...
class MoistureHistoryActivity : AppCompatActivity() {
    ...
    private fun updateChart(entries: List<Entry>, labels: List<String>) {
        ...
        dataSet.color = ContextCompat.getColor(this@MoistureHistoryActivity, R.color.theme_green)
        dataSet.setDrawFilled(true)
        dataSet.fillColor = ContextCompat.getColor(this@MoistureHistoryActivity, R.color.theme_green)
        dataSet.fillAlpha = 100
        dataSet.setDrawCircles(true)
        dataSet.setCircleColors(listOf(ContextCompat.getColor(this@MoistureHistoryActivity, R.color.theme_green)))
        dataSet.circleRadius = 5f
        dataSet.circleHoleColor = ContextCompat.getColor(this@MoistureHistoryActivity, R.color.theme_green)
